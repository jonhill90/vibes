# Source: infra/task-manager/backend/src/mcp_server.py
# Lines: 20-199
# Pattern: MCP Consolidated Tool Pattern (find/manage)
# Extracted: 2025-10-11
# Relevance: 10/10 - Critical for MCP tool design

"""
PATTERN: Consolidated MCP Tools (find/manage pattern)

This demonstrates the consolidated tool pattern where:
- find_[resource]() handles list/search/get operations
- manage_[resource]() handles create/update/delete operations
...
# Optimization constants (CRITICAL for MCP)
