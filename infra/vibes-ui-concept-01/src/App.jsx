...
function App() {
  ...
  const agents = [
    { id: 'coding', icon: Code, name: 'Coding Agent', color: 'bg-blue-500' },
    { id: 'writing', icon: PenTool, name: 'Writing Agent', color: 'bg-green-500' },
    { id: 'research', icon: Search, name: 'Research Agent', color: 'bg-purple-500' },
    { id: 'deploy', icon: Rocket, name: 'Deploy Agent', color: 'bg-orange-500' },
  ]
